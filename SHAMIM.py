...
def o():
    ...
    if SHAMIM == 'B':
        ...
        return None
    if SHAMIM == 'C':
        os.system('xdg-open https://facebook.com/groups/100018977162337/')
        return None
    if SHAMIM == 'D':
        os.system('xdg-open https://github.com/ShamimCyber')
        return None
    if SHAMIM == 'E':
        os.system('exit')
        return None
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/profile.php?id=100018977162337', {
...
\033[38;5;46m ..%%%%...%%..%%..%%..%%..%%...%%..%%%%%%..%%...%%.
 ...
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mFACEBOK      \033[38;5;196m: \033[38;5;195m Shamim M                \033[38;5;46m|
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mGITHUB       \033[38;5;196m:  \033[38;5;195mKgSHAMIM               \033[38;5;46m|
